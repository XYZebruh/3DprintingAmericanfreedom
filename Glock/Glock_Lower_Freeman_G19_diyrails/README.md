...
#### Description 
This project is an evolution of the FreeMenDontAsk G17 - a 3D Printable G19 frame that follows the same basic layout for its DIY rails.
...
##### FreeMan's Glock 17 Assembly Tutorial Parts 1-3 (Applies to G19 as well):
...
* Complete G19 (or G26) lower parts kit (from Midway USA or elsewhere)
* G19 (or G26) 3-pin locking block (from Midway USA or elsewhere)
...
Note that the front rail block must be bobbed from the G17 spec in order to avoid the slide crashing into the rails.
